    ...
    >
      {/* <div className='md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto'>
        ...
        <button className='md:text-base text-sm hover:border-2 border-2 border-transparent font-semibold py-3 px-8 md:px-10 text-white bg-rose-600 hover:border-rose-600 hover:bg-transparent hover:text-rose-600 rounded-full'>
          <Link
            href='https://apps.apple.com/vn/app/money-pig/id6737252796'
            target='_blank'
          >
            Explore
          </Link>
      ...
      <div className='w-full relative'>
        {/*     before:bg-[url('/herobg1.png')]
        after:bg-[url('/herobg2.png')]  */}
        <div
          className='p-8 before:w-full before:h-full before:absolute before:top-0 before:left-0 
         before:bg-left-bottom before:bg-contain before:bg-no-repeat before:-z-50 after:w-full after:h-full after:absolute after:top-0 after:left-0 after:bg-right after:bg-contain after:bg-no-repeat after:-z-50'
        >
          <Image
            src={'/hero_banner.png'}
            width={0}
